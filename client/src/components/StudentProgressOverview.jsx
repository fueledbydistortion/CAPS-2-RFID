...
const StudentProgressOverview = () => {
      ...
      if (usersResult.success) {
        ...
        for (const student of students) {
          try {
            ...
            console.error(
              `Error loading badge data for student ${student.uid}:`,
              error
            );
          }
        }
  ...
  const filterStudents = () => {
    if (!searchTerm.trim()) {
      ...
      const filtered = (progressData.parentProgress || []).filter((student) => {
        ...
        const sections =
          student.sections?.map((s) => s.name.toLowerCase()).join(" ") || "";
  ...
  const getRealProgressData = (studentData) => {
    ...
    const badgeInfo = studentBadgeDataMap[studentId] || {
      badges: [],
      stats: {},
    };
    ...
    const overallProgress =
      totalLessons > 0
        ? Math.round(
            lessons.reduce((sum, lesson) => sum + (lesson.percentage || 0), 0) /
              totalLessons
          )
        : 0;
            ...
            <Box
              ...
              <Card
                ...
                <CardContent sx={{ textAlign: "center", p: 3 }}>
                  <People
                    sx={{ fontSize: 40, color: "hsl(152, 65%, 28%)", mb: 1 }}
                  />
                  <Typography
                    variant="h4"
                    sx={{
              ...
              <Box sx={{ textAlign: "center", py: 4 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  {searchTerm
                    ...
                    : "No students are assigned to your sections yet"}
                </Typography>
              </Box>
            ) : (
              <TableContainer
                ...
                <Table stickyHeader>
                  <TableHead>
                    <TableRow
                      sx={{ backgroundColor: "rgba(31, 120, 80, 0.05)" }}>
                      <TableCell
                        sx={{
                          fontFamily: "Plus Jakarta Sans, sans-serif",
                          fontWeight: 600,
                ...
                <Box
                  ...
                  <Card
                    ...
                    <CardContent sx={{ textAlign: "center" }}>
                      <TrendingUp
                        sx={{ color: "#1976d2", fontSize: 40, mb: 1 }}
                      />
                      <Typography
                        variant="h4"
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                  {selectedStudent.sections &&
                    selectedStudent.sections.map((section, index) => (
                      <Chip
                        key={index}
                        label={`${section.name} (Grade ${section.grade})`}
                        color="primary"
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                <Box
                  ...
                  <Card
                    ...
                    <CardContent sx={{ textAlign: "center" }}>
                      <EmojiEvents
                        sx={{ color: "#ffa726", fontSize: 40, mb: 1 }}
                      />
                      <Typography
                        variant="h4"
                  ...
                  <Card
                    ...
                    <CardContent sx={{ textAlign: "center" }}>
                      <TrendingUp
                        sx={{ color: "#e91e63", fontSize: 40, mb: 1 }}
                      />
                      <Typography
                        variant="h4"
                  ...
                  <Card
                    ...
                    <CardContent sx={{ textAlign: "center" }}>
                      <CheckCircle
                        sx={{ color: "#3f51b5", fontSize: 40, mb: 1 }}
                      />
                      <Typography
                        variant="h4"
                        sx={{ fontWeight: 700, color: "#3f51b5" }}>
                        {
                          getRealProgressData(selectedStudent)
                            .collectionComplete
                        }
                      </Typography>
                      <Typography variant="body2" color="text.secondary">
