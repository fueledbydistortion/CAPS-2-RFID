...
const MessagingPage = () => {
	...
	useEffect(() => {
		if (activeConversation) {
			console.log(
				"MessagingPage - Active conversation set:",
				activeConversation
			);
	...
	useEffect(() => {
		...
		console.log(
			"MessagingPage - Listening to messages for conversation:",
			selectedConversation.conversationId
		);
		console.log(
			"MessagingPage - Selected conversation object:",
			selectedConversation
		);
		console.log(
			"MessagingPage - Conversation ID type:",
			typeof selectedConversation.conversationId
		);
	...
	const handleSendMessage = async () => {
		...
		setSending(true);
		console.log(
			"MessagingPage - Sending message to:",
			selectedConversation.conversationId
		);
	...
	const handleSelectConversation = (conversation) => {
		...
		console.log(
			"MessagingPage - Conversation lastMessage:",
			conversation.lastMessage
		);
		console.log(
			"MessagingPage - Conversation unreadCount:",
			conversation.unreadCount
		);
		console.log(
			"MessagingPage - Conversation participants:",
	...
	const handleRefresh = () => {
		...
		console.log(
			"MessagingPage - Current conversations before refresh:",
			conversations
		);
		...
		setTimeout(() => {
			setRefreshing(false);
			console.log(
				"MessagingPage - Conversations after refresh:",
				conversations
			);
		}, 1000);
	};
			...
			>
				...
				>
					<Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
						<Avatar
							sx={{ bgcolor: "hsl(152, 65%, 28%)", width: 48, height: 48 }}
						>
							<ChatIcon />
						</Avatar>
						<Box>
					...
					<StartChatButton
						...
						onConversationCreated={(conversation) => {
							console.log(
								"MessagingPage - New conversation created:",
								conversation
							);
							setSelectedConversation(conversation);
							...
							setTimeout(() => {
								console.log(
									"MessagingPage - Checking if conversation appears in list..."
								);
								console.log(
									"MessagingPage - Current conversations:",
									conversations
								);
							}, 1000);
						}}
