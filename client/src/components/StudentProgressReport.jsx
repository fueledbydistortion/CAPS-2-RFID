...
const StudentProgressReport = () => {
  ...
  const loadData = async () => {
    try {
      ...
      if (usersResult.success) {
        ...
        const studentUsers = usersResult.data.filter(
  ...
  const filterStudents = () => {
    if (!searchTerm.trim()) {
      ...
      const filtered = students.filter((student) => {
        ...
        const childName = student.childName
          ? student.childName.toLowerCase()
          : "";
  ...
  const getStudentSection = (student) => {
    const section = sections.find(
      (s) => s.assignedStudents && s.assignedStudents.includes(student.uid)
    );
    return section;
  };
  ...
  const getRealProgressData = (student) => {
    ...
    const totalPoints =
      ...
      badges.reduce((sum, badge) => sum + (badge.points || 0), 0);
  ...
  return (
    <Box>
              ...
              return (
                <TableRow
                  ...
                  <TableCell>
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      <School
                        sx={{ color: "info.main", fontSize: 16, mr: 1 }}
                      />
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>
                  ...
                  <TableCell>
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      <EmojiEvents
                        sx={{ color: "warning.main", fontSize: 16, mr: 1 }}
                      />
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>
      ...
      <Dialog
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  {getStudentSection(selectedStudent) ? (
                    <Chip
                      label={`${
                        getStudentSection(selectedStudent).name
                      } (Grade ${
                        getStudentSection(selectedStudent).grade || "undefined"
                      })`}
                      sx={{
                        bgcolor: "rgba(33, 150, 243, 0.1)",
                        color: "#1976d2",
        ...
        <DialogActions
          sx={{ display: "flex", justifyContent: "flex-end", p: 3, pt: 0 }}>
          <Button
