...
const DetailedProgressDialog = ({
  ...
  const getProgressStatus = (progress) => {
    ...
    if (progress >= 50)
      return { status: "in_progress", text: "In Progress", color: "warning" };
    if (progress > 0)
      return { status: "started", text: "Started", color: "info" };
  ...
  const formatBirthDate = () => {
    if (
      studentData?.childBirthMonth &&
      studentData?.childBirthDay &&
      studentData?.childBirthYear
    ) {
      const monthNames = [
        "January",
        "February",
      ...
      const month =
        monthNames[studentData.childBirthMonth - 1] ||
        studentData.childBirthMonth;
      ...
      <DialogContent sx={{ p: { xs: 3, md: 4, lg: 5 } }}>
        {loading ? (
          ...
          <Box
                  ...
                  <Chip
                    ...
                    icon={
                      progressStatus.status === "completed" ? (
                        ...
                        <TrendingUp />
                      ) : progressStatus.status === "not_started" ? (
                        <Warning />
                      ) : (
                        <Info />
                      )
            ...
            {/* Content Daycare Centers - Flexbox Row */}
            <Box
              sx={{
                display: "flex",
                gap: 4,
              ...
              <Box
                    ...
                    <List dense>
                      ...
                      {studentData?.firstName && (
                        <ListItem sx={{ px: 0 }}>
                          ...
                          <ListItemText
                            primary="Full Name"
                            secondary={`${studentData.firstName} ${
                      ...
                      {studentData?.organization && (
                        <ListItem sx={{ px: 0 }}>
                          ...
                          <ListItemText
                            ...
                            secondary={studentData.organization}
                          />
                        </ListItem>
                      )}
                    </List>
                    ...
                    <CardContent>
                      ...
                      <List dense>
                        {studentData?.childName && (
                          <ListItem sx={{ px: 0 }}>
                            <ListItemIcon>
                              <PersonPin sx={{ color: "#ff9800" }} />
                            </ListItemIcon>
                            <ListItemText
                              primary="Child Name"
                              secondary={studentData.childName}
                            />
                          </ListItem>
                        )}
                        {studentData?.childSex && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Gender"
                              secondary={studentData.childSex}
                            />
                          </ListItem>
                        )}
                        {(studentData?.childBirthMonth ||
                        ...
                        {studentData?.childHandedness && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Handedness"
                              secondary={studentData.childHandedness}
                            />
                          </ListItem>
                        )}
                        {studentData?.birthOrder && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Birth Order"
                              secondary={studentData.birthOrder}
                            />
                          </ListItem>
                        )}
                        {studentData?.numberOfSiblings && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Number of Siblings"
                              secondary={studentData.numberOfSiblings}
                            />
                          </ListItem>
                        )}
                      </List>
                ...
                {(studentData?.address ||
                  ...
                  <Card
                    sx={{
                      background:
                        "linear-gradient(135deg, rgba(156, 39, 176, 0.1) 0%, rgba(142, 36, 170, 0.1) 100%)",
                      ...
                      <List dense>
                        ...
                        {studentData?.barangay && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Barangay"
                              secondary={studentData.barangay}
                            />
                          </ListItem>
                        )}
                        {studentData?.municipality && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              ...
                              secondary={studentData.municipality}
                            />
                          </ListItem>
                        )}
                        {studentData?.province && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Province"
                              secondary={studentData.province}
                            />
                          </ListItem>
                        )}
                        {studentData?.region && (
              ...
              <Box
                ...
                <Card
                  sx={{
                    background:
                      "linear-gradient(135deg, rgba(31, 120, 80, 0.1) 0%, rgba(30, 136, 229, 0.1) 100%)",
                  ...
                  <CardContent>
                    <Box
                      ...
                      <School
                        sx={{ color: "hsl(145, 60%, 40%)", fontSize: "2rem" }}
                      />
                      <Typography
                        variant="h6"
                        sx={{
                    ...
                    <Typography
                      ...
                      color="text.secondary"
                      sx={{ mb: 2 }}>
                      {studentData?.completedLessons || 0} of{" "}
                      {studentData?.totalLessons || 0} lessons completed
                    </Typography>
                      ...
                      <List dense>
                        {studentData?.fatherName && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Father"
                              secondary={`${studentData.fatherName}${
                                studentData.fatherAge
                                  ? ` (Age: ${studentData.fatherAge})`
                                  : ""
                              }`}
                            />
                          </ListItem>
                        ...
                        {studentData?.fatherOccupation && (
                          <ListItem sx={{ px: 0 }}>
                            <ListItemIcon>
                              <Work sx={{ color: "#f44336" }} />
                            </ListItemIcon>
                            <ListItemText
                              primary="Father's Occupation"
                              secondary={studentData.fatherOccupation}
                            />
                          </ListItem>
                        )}
                        {studentData?.fatherEducation && (
                          <ListItem sx={{ px: 0 }}>
                            <ListItemIcon>
                              <School sx={{ color: "#f44336" }} />
                            </ListItemIcon>
                            <ListItemText
                              primary="Father's Education"
                              secondary={studentData.fatherEducation}
                            />
                          </ListItem>
                        )}
                        {studentData?.motherName && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Mother"
                              secondary={`${studentData.motherName}${
                                studentData.motherAge
                                  ? ` (Age: ${studentData.motherAge})`
                                  : ""
                              }`}
                            />
                          </ListItem>
                        ...
                        {studentData?.motherOccupation && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Mother's Occupation"
                              secondary={studentData.motherOccupation}
                            />
                          </ListItem>
                        )}
                        {studentData?.motherEducation && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Mother's Education"
                              secondary={studentData.motherEducation}
                            />
                          </ListItem>
                        )}
                      </List>
                ...
                {studentData?.schoolName && (
                  <Card
                    sx={{
                      background:
                        "linear-gradient(135deg, rgba(103, 58, 183, 0.1) 0%, rgba(94, 53, 177, 0.1) 100%)",
                    ...
                    <CardContent>
                      ...
                      <List dense>
                        <ListItem sx={{ px: 0 }}>
                          ...
                          <ListItemText
                            primary="School Name"
                            secondary={studentData.schoolName}
                          />
                        </ListItem>
                        {studentData?.isStudying && (
                          <ListItem sx={{ px: 0 }}>
                            ...
                            <ListItemText
                              primary="Currently Studying"
                              secondary={studentData.isStudying}
                            />
                          </ListItem>
                        )}
                      </List>
