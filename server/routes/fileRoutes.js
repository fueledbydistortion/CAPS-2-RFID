...
router.post('/lesson/:lessonId/upload', upload.array('files', 5), uploadLessonFiles);  // Upload files to lesson
...
router.post('/profile-picture/:uid', authenticateToken, upload.single('profilePicture'), uploadProfilePicture); // Upload profile picture
