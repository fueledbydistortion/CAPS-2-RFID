...
function Dashboard() {
  ...
  const getActiveMenu = () => {
    ...
    if (location.pathname === "/dashboard/parent-schedules")
      return "My Schedules";
    ...
    if (location.pathname === "/dashboard/notification-settings")
  ...
  const getPageTitle = () => {
    ...
    if (location.pathname === "/dashboard/users")
      return "Smart Child Care - Users Module";
    if (location.pathname === "/dashboard/students")
      return "Smart Child Care - Students Module";
    if (location.pathname === "/dashboard/my-student")
      return "Smart Child Care - My Student";
    if (location.pathname === "/dashboard/schedules")
      return "Smart Child Care - Schedules Module";
    if (location.pathname === "/dashboard/parent-schedules")
      return "Smart Child Care - My Schedules";
    if (location.pathname === "/dashboard/parent-content")
      return "Smart Child Care - Learning Content";
    ...
    if (location.pathname === "/dashboard/badges")
      return "Smart Child Care - Badges Module";
    if (location.pathname === "/dashboard/reports")
      return "Smart Child Care - Reports Module";
    if (location.pathname === "/dashboard/messaging")
      return "Smart Child Care - Messaging Module";
    if (location.pathname === "/dashboard/notification-settings")
      return "Smart Child Care - Notification Settings";
    ...
    if (userProfile?.role === "parent") {
      return [
        ...baseItems,
        {
          text: "My Student",
          icon: <Person />,
          active: activeMenu === "My Student",
        },
        {
          text: "My Schedules",
          icon: <Schedule />,
          active: activeMenu === "My Schedules",
        },
        {
          text: "Calendar",
          icon: <CalendarToday />,
        ...
        },
        {
          ...
          icon: <Book />,
          active: activeMenu === "Learning Content",
        },
        {
          text: "Messaging",
          icon: <Message />,
          active: activeMenu === "Messaging",
        },
        {
          text: "Badges",
          icon: <EmojiEvents />,
          active: activeMenu === "Badges",
        },
        {
          text: "Notification Settings",
          icon: <Settings />,
          active: activeMenu === "Notification Settings",
        },
      ];
    } else {
      ...
      if (userProfile?.role !== "admin" && userProfile?.role !== "teacher") {
        menuGroups.management = menuGroups.management.filter(
          (item) => item.text !== "Students"
        );
        menuGroups.communication = menuGroups.communication.filter(
          (item) => item.text !== "Reports"
        );
      }
  ...
  const drawer = (
    <Box
      sx={{
        ...
        flexDirection: "column",
        background:
          "linear-gradient(180deg, hsl(152, 65%, 28%) 0%, hsl(145, 60%, 40%) 100%)",
        width: "100%",
        maxWidth: "100%",
        overflowX: "hidden",
      }}>
          ...
          {userProfile?.role === "parent" ? (
            ...
            <>
              ...
              {menuItems.communication &&
                menuItems.communication.length > 0 && (
                  <>
                    <Divider
                      sx={{
                        my: 2,
